...
$apiToken = '4E2OLjHJifbLGELU5Z7GzdBPf90TVgJUDYyaEi8ermNgC9QtihlyPJO8Tavr';
...
$data = [
    ...
    "offer_hash" => "fo9wl3oeck", // Mantenha ou substitua por um hash de oferta válido
    "payment_method" => "pix",
    "customer" => [
        "name" => $nomeAleatorio,
    ...
    "cart" => [
        [
            "product_hash" => "aagp8kdcpd", // Mantenha ou substitua por um hash de produto válido
            "title" => $productTitle,
            "price" => $amountInCents,
            "quantity" => 1,
            "operation_type" => 1,
